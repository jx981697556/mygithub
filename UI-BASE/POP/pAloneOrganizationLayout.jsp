...
<html>
	...
	var url_delAction = "admin/AloneOrganizationdeleteCommit.do";
	var url_formAction = "admin/AloneOrganizationshow.do";
	var url_searchAction = "admin/AloneOrganizationqueryAll.do";
	var title_window = "组织机构";
