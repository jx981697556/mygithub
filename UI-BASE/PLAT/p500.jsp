...
<%@page import="java.text.SimpleDateFormat"%>
<%@ page import="java.io.*"%>
<%@page import="com.farm.console.prisist.domain.AloneUser"%>
<%
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="text-align: center; background-color: #ffffff;">
		<div id="imgDivId"
			style="margin: auto; background-image: url('WEB-FACE/img/temp/500.png'); width: 750px; height: 450px;">

		</div>
		<div onclick="showDetailMessager()" id="buttonTitleId" style="text-decoration: underline;font-weight: bold;cursor: pointer;" >显示详细错误信息</div>
...
//-->
 	...
 	try {
 		...
 		printStream.println("账号："
 				+ ((AloneUser)request.getSession().getAttribute("USEROBJ")).getName());
 		printStream
 				.println("访问的路径: "
 						+ request
